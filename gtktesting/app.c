...
void on_hapus_clicked(GtkWidget *widget, gpointer data);
void on_cari_clicked(GtkWidget *widget, gpointer data);
void on_tambah_clicked(GtkWidget *widget, gpointer data);
...
void on_edit_data_pasien_clicked(GtkWidget *widget, gpointer data) {
    create_submenu("Edit Data Pasien", G_CALLBACK(on_edit_clicked), G_CALLBACK(on_hapus_clicked), G_CALLBACK(on_cari_clicked), G_CALLBACK(on_tambah_clicked));
}

void on_edit_riwayat_clicked(GtkWidget *widget, gpointer data) {
    create_submenu("Edit Riwayat", G_CALLBACK(on_edit_clicked), G_CALLBACK(on_hapus_clicked), G_CALLBACK(on_cari_clicked), G_CALLBACK(on_tambah_clicked));
}
